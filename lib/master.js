...
async function http_get_json(url, fetch_mode=17, request_opt=null) {
	...
	*/
	...
	if ( ((fetch_mode & 32768) != 32768) && (! await xhr.ok) ) { throw { title: `HTTP Error: ${url}`, url: url, ok: await xhr.ok, message: await xhr.statusText, code: await xhr.status, redirected: await xhr.redirected } }

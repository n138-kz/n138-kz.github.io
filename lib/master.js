...
window.addEventListener('load', ()=>{
	...
	console.debug(`Ad link has set: ${url}, RAND: ${list[getRandomIntInclusive(0,list.length-1)]}`);
});
window.addEventListener('load', ()=>{
